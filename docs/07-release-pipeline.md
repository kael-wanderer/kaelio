...
GitHub Actions CI/CD builds Kaelio for 3 platforms on tag push, generates signed updater artifacts, and creates a GitHub Release with `latest.json` for auto-update.
